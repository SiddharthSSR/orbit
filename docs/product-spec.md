...
- Provide an Ask tab connected to the backend mock AI provider for non-streaming chat over bounded, date-aware, keyword-relevant Orbit context, with a lightweight context inspection panel.
